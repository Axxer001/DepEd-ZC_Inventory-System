...
<div id="step2" class="step-content text-center">
    ...
    <div class="flex flex-wrap justify-center gap-6 max-w-5xl mx-auto px-4">
        ...
        <div onclick="nextStep(3, 'school')" class="bg-white p-8 w-full sm:w-[256px] rounded-[2.5rem] shadow-lg border border-slate-100 hover:border-[#c00000] hover:-translate-y-2 transition-all cursor-pointer group">
            ...
            <p class="category-subtext text-[9px] text-slate-400 uppercase font-bold mt-2 tracking-tighter leading-tight opacity-70" data-add="Register new school profiles" data-edit="Modify existing school records"></p>
        </div>

        {{-- Resource Providers (Distributors) --}}
        <a id="providerLink" href="{{ route('inventory.setup.add_distributors') }}" class="bg-white p-8 w-full sm:w-[256px] rounded-[2.5rem] shadow-lg border border-slate-100 hover:border-[#c00000] hover:-translate-y-2 transition-all cursor-pointer group block text-center">
            ...
            <span class="block font-extrabold text-slate-800 uppercase text-[10px] tracking-widest">Resource Providers</span>
            <p class="category-subtext text-[9px] text-slate-400 uppercase font-bold mt-2 tracking-tighter leading-tight opacity-70" data-add="Register new asset sources" data-edit="Modify existing provider info"></p>
        </a>
        ...
        <a href="{{ route('inventory.setup.add_recipients') }}" class="bg-white p-8 w-full sm:w-[256px] rounded-[2.5rem] shadow-lg border border-slate-100 hover:border-[#c00000] hover:-translate-y-2 transition-all cursor-pointer group block text-center">
            ...
            <p class="category-subtext text-[9px] text-slate-400 uppercase font-bold mt-2 tracking-tighter leading-tight opacity-70" data-add="Add new asset receivers" data-edit="Update recipient details"></p>
        </a>
        ...
        <div onclick="nextStep(3, 'item')" class="bg-white p-8 w-full sm:w-[256px] rounded-[2.5rem] shadow-lg border border-slate-100 hover:border-[#c00000] hover:-translate-y-2 transition-all cursor-pointer group">
            ...
            <p class="category-subtext text-[9px] text-slate-400 uppercase font-bold mt-2 tracking-tighter leading-tight opacity-70" data-add="Register new supply items" data-edit="Edit item specifications"></p>
        </div>
        ...
        <div onclick="nextStep(3, 'distribution')" class="bg-white p-8 w-full sm:w-[256px] rounded-[2.5rem] shadow-lg border border-slate-100 hover:border-[#c00000] hover:-translate-y-2 transition-all cursor-pointer group">
            ...
            <p class="category-subtext text-[9px] text-slate-400 uppercase font-bold mt-2 tracking-tighter leading-tight opacity-70" data-add="Record new asset deployment" data-edit="Modify deployment history"></p>
        </div>
