...
<body class="bg-slate-50 min-h-screen flex text-slate-900 overflow-x-hidden">
    ...
    <div class="w-full mx-auto p-6 lg:p-10 min-h-screen flex flex-col">
        ...
        <div class="flex justify-between items-center mb-10 px-2">
            <div>
                <h2 class="text-3xl font-black text-slate-800 uppercase italic leading-none">Building Records</h2>
                <p class="text-slate-400 text-xs font-bold uppercase tracking-[0.2em] mt-2">View and manage master building registry</p>
            </div>
            <div class="flex items-center gap-4">
                <button onclick="toggleBldgFilters()" id="toggleFilterBtn" class="px-6 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest text-slate-500 bg-white border border-slate-100 hover:border-red-600 transition-all flex items-center gap-2 active:scale-95 shadow-sm italic">
        ...
        <div id="bldgFilterSection" class="bg-white rounded-[2.5rem] shadow-lg border border-slate-100 p-8 mb-8 relative z-50 animate-fade transition-all duration-300 origin-top">
        ...
        <div class="bg-white rounded-[2rem] border border-slate-100 shadow-lg overflow-hidden flex flex-col animate-fade relative">
            ...
            <div id="bldgTableFooter" class="px-6 py-4 border-t border-slate-100 flex items-center justify-between bg-white dark:bg-slate-900 relative z-30 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
                <div class="flex items-center gap-6">
                    <p id="bldgRowCountLabel" class="text-[9px] font-black text-slate-400 uppercase tracking-widest">0 Rows</p>
                    <div id="bldgPaginationControls" class="flex items-center gap-3 border-l border-slate-200 dark:border-slate-800 pl-6">
                        <button onclick="bldgPrevPage()" id="bldgPrevBtn" class="pg-btn">
                            <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M15 19l-7-7 7-7"/></svg>
                            Prev
                        </button>
                        <div class="glass-indicator">
                            <span id="bldgCurrentPage" class="text-[10px] font-black text-white dark:text-blue-400">1</span>
    ...
    <div id="depTooltip" class="dep-tooltip">
        <div class="flex items-center gap-3 mb-4">
            ...
            <div>
                ...
                <h4 class="text-xs font-bold text-white uppercase italic">Depreciation Preview</h4>
            </div>
        </div>
