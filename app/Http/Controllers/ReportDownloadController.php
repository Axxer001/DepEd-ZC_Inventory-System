        ...
        if ($tab === 'source') {
            $query = DB::table('asset_sources')
                ...
                ->select(
                    ...
                    DB::raw('COALESCE(asset_sources.contact_person, acquisition_sources.contact_person) as source_personnel'),
                    DB::raw('COALESCE(asset_sources.contact_position, acquisition_sources.contact_position) as personnel_position'),
