        ...
        <div class="p-8 overflow-y-auto custom-scroll flex-1 space-y-10">
            <div>
                ...
                <div class="grid grid-cols-3 gap-x-6 gap-y-5">
                    ...
                    <div class="relative"><label class="text-[9px] font-black text-slate-400 uppercase tracking-widest ml-1 block mb-1 text-emerald-600">Acquisition Date</label><input type="date" id="bbAcqDate" class="xls-input !border border-slate-200 dark:border-slate-800 rounded-xl"></div>
